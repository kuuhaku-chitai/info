...
import { fetchPublishedPosts, fetchAllSocialLinks } from '@/lib/actions';
...
export default async function BlogPage() {
  // サーバーサイドでデータを取得
  const [allPosts, socialLinks] = await Promise.all([
    fetchPublishedPosts(),
    fetchAllSocialLinks(),
  ]);
  ...
  return <BlogContent posts={posts} socialLinks={socialLinks} />;
}
